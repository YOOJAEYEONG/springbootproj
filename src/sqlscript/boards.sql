...
FROM BOARDS
WHERE BOARD_NAME = 'freeBoard'

	AND UNIX_TIMESTAMP(UPDATE_DATE)  >=  UNIX_TIMESTAMP('2021-04-08')
   AND UNIX_TIMESTAMP(UPDATE_DATE)  <  UNIX_TIMESTAMP('2021-05-27') 
ORDER BY POST_ID DESC
LIMIT 0, 10
) B;

SELECT UNIX_TIMESTAMP('2020-03-22') FROM DUAL;